...
stm32_peripherals::stm32_peripherals(const sc_module_name& nm):
    ...
    rcc_cfgr("rcc_cfgr", 0x1004, 0x0028000A), // 0x40021004 Default: SWS = 10 → PLL as SYSCLK, HPRE = /1, PPRE = /1
    rcc_cfgr2("rcc_cfgr2", 0x1030, 0x00000000), // 0x40021030 Default: None
    rcc_cfgr3("rcc_cfgr3", 0x1034, 0x00000000), // 0x40021034 Default: None
    ...
    in("in"){
        ...
        rcc_cfgr.on_write(&stm32_peripherals::write_rcc_cfgr);
    } 
...
void stm32_peripherals::write_rcc_cfgr(u32 val) {
